...
class Detect_marker(object):
    ...
    def move(self, y,d):
        global done
        self.mc.send_coords([coords[0], coords[1]+int(y),350,85, 45, 85], 80, 0)
        time.sleep(1.5)
        done = True
        print("Done")
    ...
    def move_back(self,d):
        ...
        time.sleep(2)
        basic.grap(False)
        angles = [29.53, -79.36, 93.86, -16.08, -29.97, 135.35]
        self.mc.send_angles(angles, 50)
    ...
    def init_mycobot(self):
        self.mc.send_coords([149.4, -13.6, 320.0, 90,45,90],20,0) 
        basic.grap(False)
