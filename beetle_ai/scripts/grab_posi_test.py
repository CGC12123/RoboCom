...
coords_target_2 = [coords_ori[0] + grabParams.bias_right_low_x,  coords_ori[1] + grabParams.bias_right_low_y + 35,  
...
mc.send_coords(coords_target_2, 70, 0)
time.sleep(1)
coords_target_2 = [coords_ori[0] + grabParams.bias_right_low_x,  coords_ori[1] + grabParams.bias_right_low_y,  
                           coords_ori[2] + grabParams.bias_right_low_z, coords_ori[3], coords_ori[4], coords_ori[5]]
# coords_target_2 = [coords_ori[0] + grabParams.bias_right_high_x,  coords_ori[1],  
#                    coords_ori[2] + grabParams.bias_right_high_z, coords_ori[3], coords_ori[4], coords_ori[5]]

mc.send_coords(coords_target_2, 70, 0)
time.sleep(0.4)
# 移动到目标位置
# coords_target_2 = [coords_ori[0] + grabParams.bias_right_high_x,  coords_ori[1] + 50,
#                    coords_ori[2] + grabParams.bias_right_high_z, coords_ori[3], coords_ori[4], coords_ori[5]]
# mc.send_coords(coords_target_2, 70, 0)
# time.sleep(1)
